	...
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			context = {
				...
				DIABETES_VID_NAME: RECORD_TYPES_SELECTED[DIABETES_VID_NAME],
...
DIABETES_VID_NAME = 'diabetes_vid'
...
DIABETES_VID_DISPLAY_NAME = 'Diabetes Videos'
...
def get_recordtypes_perm(researcher):
	...
	if (researcher.get_diabetes_vid_perm()):
		RECORD_TYPES_PERMISSION.append((DIABETES_VID_NAME, DIABETES_VID_DISPLAY_NAME))
